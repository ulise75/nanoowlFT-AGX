#!/usr/bin/env python3
# Simple CPU-based OWL-ViT prediction example

import PIL.Image
from nanoowl.owl_predictor import OwlPredictor
from nanoowl.owl_drawing import draw_owl_output

# Initialize predictor on CPU (no TensorRT engine needed)
print("Initializing OWL-ViT predictor on CPU...")
...
output_image.save("../data/owl_predict_cpu_out.jpg")
print("✓ Saved to: data/owl_predict_cpu_out.jpg")
